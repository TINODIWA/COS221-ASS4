...
public class AddProduct extends JDialog {
    private final JTextField  product_code_field, product_name_field, description_field, 
    ...
    private final JComboBox<String> supplier_id_box, category_box;
    
    public AddProduct(ProductsTab parent){
...
//        String idText = id_field.getText().trim();
        ...
        if (listPriceText.isEmpty() || discontinuedText.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please fill at least List Price and Discontinued.");
            return;
        }
