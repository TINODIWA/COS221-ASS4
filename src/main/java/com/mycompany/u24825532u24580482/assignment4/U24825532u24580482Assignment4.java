...
//            String password = scanner.nextLine();
            ...
            String db_proto = d.get("dvdrental_DB_PROTO");
            String db_host = d.get("dvdrental_DB_HOST");
            String db_port = d.get("dvdrental_DB_PORT");
            String db_name = d.get("dvdrental_DB_NAME");
            
            db_username = d.get("dvdrental_DB_USERNAME");
            db_password = d.get("dvdrental_DB_PASSWORD");
